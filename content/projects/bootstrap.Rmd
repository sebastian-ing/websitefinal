...
categories:
- "Social media"
date: "2020-10-13T22:26:09-05:00"
...
proportion_gss <- Gss_mod %>%
  ...
  # Fixes table
kable(caption = "Proportion of people using snapchat or instagram",
...
proportion_ci <- Gss_mod %>%
  ...
  kable(caption = "Proportion of people using snapchat or instagram based on gender",
...
proportion_gss2 <- Gss_mod2 %>%
  ...
  #fixes aesthetics
  kable(caption = "Proportion of people using twitter with bachelor or graduate degrees",
...
proportion_ci2 <- Gss_mod2 %>%
  ...
  #fixes aesthetics
  kable(caption = "Proportion and confidence intervals of people using twitter based on education",
...
mutate(lower_ci_hour = lower_ci %/% 60,
  ...
  # Table format
  kable(caption = "Confidence interval for time spent on emails per week",
             col.names = c("Lower CI", "Upper CI")) %>% 
  kable_material_dark("striped", full_width = TRUE)
